  ...
  ngOnInit() {
    ...
    if (this.type == Symbol.button) {
      if (this.diagramData.func === ButtonFunction.command) {
        this.hasDataMapped =
          this.diagramData.verb && this.diagramData.verb !== "";
      ...
      const dataType = this.diagramData.controlData[0].type;
      ...
      if (dataType === "binary") {
        ...
        const cmd = this.findCommand(this.diagramData.controlData[0].path);
        if (cmd != null) {
          this.isControllable = canControl;
          this.hasDataMapped = true;
          ...
          console.error(
            "Data type for control point is not supported: " + dataType,
          );
          this.isControllable = false;
        }
      }
  ...
  onAction(): void {
    ...
    if (this.isSetPoint) {
      ...
      this.dialogRef.close({
        ...
        action: this.diagramData.verb
          ? this.diagramData.verb
          : CommandAction.SETVALUE,
