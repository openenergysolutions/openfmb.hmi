...
impl Actor for GuiPublisher {
    type Msg = GuiPublisherMsg;
...
impl Receive<RequestActorStats> for GuiPublisher {
    type Msg = GuiPublisherMsg;
...
impl Receive<OpenFMBMessage> for GuiPublisher {
    type Msg = GuiPublisherMsg;
