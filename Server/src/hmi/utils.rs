...
pub fn set_ess_csg(
    ...
    schedule_time: SystemTime) -> Option<EssControlProfile> {
...
fn ess_point(generic_control: ControlType, schedule_time: SystemTime) -> Option<EssPoint> {
    match generic_control {
        ControlType::BlackStartEnable => {
            ...
            pt.black_start_enabled = Some(ControlSpc {
                ctl_val: true
            });
            return Some(pt);
        }
        ...
        ControlType::FrequencySetPointEnable => {
            let mut pt = create_ess_point(schedule_time); 
            pt.frequency_set_point_enabled = Some(ControlSpc {
                ctl_val: true
            });
            return Some(pt);
        }
        ...
        ControlType::ReactivePowerSetPointEnable => {
            let mut pt = create_ess_point(schedule_time); 
            pt.reactive_pwr_set_point_enabled = Some(ControlSpc {
                ctl_val: true
            });
            return Some(pt);
        }
        ...
        ControlType::RealPowerSetPointEnable => {
            let mut pt = create_ess_point(schedule_time); 
            pt.real_pwr_set_point_enabled = Some(ControlSpc {
                ctl_val: true
            });
            return Some(pt);
        }
        ...
        ControlType::TransToIslandOnGridLossEnable => {
            let mut pt = create_ess_point(schedule_time); 
            pt.trans_to_islnd_on_grid_loss_enabled = Some(ControlSpc {
                ctl_val: true
            });
            return Some(pt);
        }
        ...
        ControlType::VoltageSetPointEnable => {
            let mut pt = create_ess_point(schedule_time); 
            pt.voltage_set_point_enabled = Some(ControlSpc {
                ctl_val: true
            });
            return Some(pt);
        }
